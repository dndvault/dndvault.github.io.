...
![The miracles and conflicts of the gods play out endlessly in the stars of Nyx](img/book/MOT/066-03-12.webp)
...
![Shore of the Tartyx River](img/book/MOT/067-03-13.webp)
...
![The Underworld ward of Nerono](img/book/MOT/068-03-14.webp)
...
***Blessing of Farsight (Requires Piety 3+).*** You have advantage on Wisdom (Perception) checks that rely on sight.
...
![](img/book/MOT/073-02-03-athreos.webp)
...
![The shores of the Rivers that Ring the World are watched by Athreos and his servants](img/book/MOT/074-04-05.webp)
...
![Map 4.1: Underworld Crossing](img/book/MOT/076-map-4.1-Underworld-Crossing.webp)![Player Version](img/book/MOT/077-map-4.1-Underworld-Crossing-player.webp)
...
|  2  | A conquering general captures a number of **Underworld cerberi** (see *chapter 6*), plotting to unleash the terrifying beasts during a war.                                                             |
...
|  4  | A **nightmare shepherd** (see *chapter 6*) takes over a crossing and doesn't allow souls to pass into the Underworld. As a result, they become **specters** that harass the living in the mortal world. |
...
![](img/book/MOT/076-02-03-ephara.webp)
...
![Ephara's urn is a fountain of blessings](img/book/MOT/077-04-06.webp)
...
![Map 4.2: Agora](img/book/MOT/081-map-4.2-Asora.webp)![Player Version](img/book/MOT/082-map-4.2-Asora-player.webp)
#### Agora Villains
...
|  2  | A group of **thugs** vandalizes market stalls whose owners don't pay a weekly protection fee.                                     |
|  3  | **Cultists** of Pharika plot to spike the wine at a party in the agora with an experimental poison.                               |
...
![](img/book/MOT/080-02-03-erebos.webp)
...
* See *chapter 6* for details about these creatures in Theros.
![Erebos's minions hunt the Returned and warn those who consider the same folly](img/book/MOT/081-04-08.webp)
...
![Map 4.3: Graveyard](img/book/MOT/086-map-4.3-Graveyard.webp)![Player Version](img/book/MOT/087-map-4.3-Graveyard-player.webp)
...
|  3  | A priest removes limbs from corpses to build an congregation of **flesh golems** he can't control.                                                        |
...
![](img/book/MOT/084-02-03-heliod.webp)
...
![Heliod's spear doles out his blessings as well as his wrath](img/book/MOT/085-04-10.webp)
...
![Map 4.4: Sun Temple](img/book/MOT/091-map-4.4-Sun-Temple.webp)![Player Version](img/book/MOT/092-map-4.4-Sun-Temple-player.webp)
#### Sun Temple Villains
...
![](img/book/MOT/088-02-03-iroas.webp)
...
![Map 4.5: Arena](img/book/MOT/096-map-4.5-arena.webp)![Player Version](img/book/MOT/097-map-4.5-arena-player.webp)
#### Arena Villains
...
![](img/book/MOT/092-02-03-karametra.webp)
...
|     12    | **Archdruid**        |
* See *chapter 6* for details about these creatures in Theros.
![Karametra's acolytes gather the bounty of the wilds for the god's feasts in Setessa](img/book/MOT/093-04-14.webp)
...
![Map 4.6: Arbor Watchtower](img/book/MOT/101-map-4.6-Arbor-Watchtower.webp)![Player Version](img/book/MOT/102-map-4.6-Arbor-Watchtower-player.webp)
#### Watchtower Villains
...
|  3  | **Sirens** (see the harpies entry in *chapter 6*) call soldiers to the top of the watchtower, then entice them over the edge so they can feast on the corpses. |
...
|  7  | **Blood-toll harpies** (see *chapter 6*) take over a watchtower and light its beacon to bring more victims to the place.                                       |
|  8  | A **spy** in a watchtower poisons the tower's food supply in advance of an upcoming attack.                                                                    |

## Keranos

![](img/book/MOT/096-02-03-keranos.webp)
...
* See *chapter 6* for details about these creatures in Theros.
![The mountain temples of Keranos are constantly wrapped in storm clouds](img/book/MOT/097-04-16.webp)
...
![Map 4.7: Oracular Conflux](img/book/MOT/105-map-4.7-Oracular-Conflux.webp)![Player Version](img/book/MOT/106-map-4.7-Oracular-Conflux-player.webp)
...
![](img/book/MOT/099-02-03-klothys.webp)
...
|  2  | Believing in the holiness of a terrible beast, Klothys's **acolytes** murder heroes sent to deal with it.                                                        |
|  3  | Certain that civilization offends fate, a **priest** raises a herd of **typhons** to release on a city.                                                          |
|  4  | Insulted **satyr revelers** (see *chapter 6*) channel Klothys's magic to drive a polis's priests into embarrassing debauchery.                                   |
...
![Map 4.8: Abandoned Temple](img/book/MOT/110-map-4.8-Abandoned-Temple.webp)![Player Version](img/book/MOT/111-map-4.8-Abandoned-Temple-player.webp)
...
|  5  | **Blood-toll harpies** make an abandoned temple their nest and devour any creatures that get too close.                                                                                      |
...
![](img/book/MOT/103-02-03-kruphix.webp)
...
![Map 4.9: Temple of Mystery](img/book/MOT/115-map-4.9-Temple-of-Mystery.webp)![Player Version](img/book/MOT/116-map-4.9-Temple-of-Mystery-player.webp)
...
![](img/book/MOT/107-02-03-mogis.webp)
...
|     8     | **Blackguard**      |
* See *chapter 6* for details about these creatures in Theros.
![Temples to Mogis can be found scattered across the badlands of Phoberos](img/book/MOT/108-04-21.webp)
...
|  3  | Find a band of **minotaurs** residing in the canyon and convince them to attack a gang of undead about to pass through on their way to attack a village. |
...
![Map 4.10: Canyon Shrine](img/book/MOT/120-map-4.10-Canyon-Shrine.webp)![Player Version](img/book/MOT/121-map-4.10-Canyon-Shrine-player.webp)
...
|  2  | A tribe of **berserkers** ride **giant bats** and hunt humanoids that travel through the canyon.                                      |
...
|  5  | A group of **cyclopes** capture travelers and keep them as livestock in their caves.                                                  |
...
![](img/book/MOT/111-02-03-nylea.webp)
...
![Nylea's sacred lynx guards those who honor the Nessian Wood and hunts those who don't](img/book/MOT/112-04-23.webp)
...
![Map 4.11: Forest Shrine](img/book/MOT/125-map-4.11-Forest-Shrine.webp)![Player Version](img/book/MOT/126-map-4.11-Forest-Shrine-player.webp)
...
|  d6 | Villain                                                                                                                                                          |
|:---:|------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|  1  | A group of **dryads**, enraged by seeing a section of forest burned, plots to destroy the shrine in order to punish the druids for failing to protect the trees. |
...
![](img/book/MOT/115-02-03-pharika.webp)
...
|  3  | Legend tells of a hydra with alchemical lore scribed upon its bones. When an alchemist (**mage**) begins poisoning the beasts, Nylea sends dozens of **hydras** to seek revenge, catching innocents in the fray. |
...
|     17    | **Hythonia**                       |
* See *chapter 6* for details about these creatures in Theros.
![Pharika's clerics believe that they are better healers because they are so well acquainted with death](img/book/MOT/116-04-25.webp)
...
![Map 4.12: Healing Pools](img/book/MOT/130-map-4.12-Healing-Pools.webp)![Player Version](img/book/MOT/131-map-4.12-Healing-Pools-player.webp)
...
|  d6 | Villain                                                                                                                                               |
|:---:|-------------------------------------------------------------------------------------------------------------------------------------------------------|
|  1  | A group of **Returned palamnites** (see *chapter 6*) invade the pools, believing the waters' magic can restore their lost memories and mortal bodies. |
|  2  | **Naiads** (see *chapter 6*) guard the pools, making their own judgments about who is and isn't worthy of the pools' healing magic.                   |
...
![](img/book/MOT/119-02-03-phenax.webp)
...
|  6  | A group of vocal iconoclasts (**nobles**) are fomenting social upheaval that threatens to turn to violence.                                          |
...
|  8  | Folk go missing then turn up with no memory of their disappearance. Phenax **cult fanatics** are brainwashing these souls for use as sleeper agents. |
...
![Followers of Phenax have little respect for the rest of the pantheon](img/book/MOT/120-04-27.webp)
...
![Map 4.13: Amphitheater](img/book/MOT/135-map-4.13-Amphitheater.webp)![Player Version](img/book/MOT/136-map-4.13-Amphitheater-player.webp)
...
|  6  | Burglars (**veterans**) masquerading as acrobats identify marks during their performances, then rob them afterward.                                                 |
...
![](img/book/MOT/123-02-03-purphoros.webp)
...
|  6  | A group of **oreads** (see *chapter 6*) seeks inspiration in flames. The oreads leave Purphoros's forge and conduct thorough studies of everything they burn.         |
...
* See *chapter 6* for details about these creatures in Theros.
![The oracles of Purphoros read the god's will in earth, fire, and volcanic fumes](img/book/MOT/124-04-29.webp)
...
![Map 4.14: Volcano Temple](img/book/MOT/140-map-4.14-Volcano-Temple.webp)![Player Version](img/book/MOT/141-map-4.14-Volcano-Temple-player.webp)
...
![](img/book/MOT/127-02-03-Thassa.webp)
...
|  3  | A **druid** of Thassa, after being mistreated by a coastal community, uses magic to lure a plague of **giant crabs** out of the depths to take revenge.                                           |
...
|  6  | A ship carrying a massive pearl sacred to Thassa has been sunk. Thassa's **cultists** want the pearl back, but anyone trying to retrieve it find that the god's triton followers have claimed it. |
...
|     26    | **Tromokratis**            |
* See *chapter 6* for details about these creatures in Theros.
![The floor of the Siren Sea is littered with vessels that navigated the waves unwelcomed](img/book/MOT/128-04-31.webp)
...
![Map 4.15: Coastal Temple](img/book/MOT/145-map-4.15-Coastal-Temple.webp)![Player Version](img/book/MOT/146-map-4.15-Coastal-Temple-player.webp)
...
|  3  | A group of sirens (see the **harpies** entry in *chapter 6*) take over the temple and lure new victims inside to drown themselves during high tide. |
...
![The kraken Arixmethes carries the ruins of a lost city affixed to the length of its spine](img/book/MOT/131-04-33.webp)
...
![Upon one of the Dakra Isles, trespassers learn the truth behind the storied Curse of the Swine](img/book/MOT/132-04-34.webp)
...
![As the people of Olantin discovered, ages of prosperity and culture mean nothing in the face of a wrathful sea](img/book/MOT/133-04-35.webp)
...
![Funerary masks help the newly dead resist the erosion of memory and identity in the Underworld](img/book/MOT/134-04-36.webp)
...
![Those who follow the Path of Phenax might return to the mortal world, but they never regain the lives they lost](img/book/MOT/135-04-37.webp)
...
*Kytheon gaped, both at the spear and at the task the god had set before him.*— Ari Levitch, "Gideon: Kytheon Iora of Akros"![Within his workshop, the triton genius Dalakos equips a satyr and leonin with the tools they need to become legends](img/book/MOT/141-05-01.webp)
...
![Cyclopes would rather steal the bounty of smaller beings than toil themselves](img/book/MOT/150-06-02.webp)
...
![Unleashed from the darkest ocean depths, each nadir kraken is a unique aquatic nightmare](img/book/MOT/151-06-03.webp)
...
![From the foulest reaches of the Underworld, night hags invade the dreams of mortals](img/book/MOT/152-06-04.webp)
...
![Although they possess great wisdom, sphinxes won't share their secrets with just anyone](img/book/MOT/153-06-05.webp)
...
![On the Cover: The invulnerable hero, Haktos the Unscarred, leaps into battle with a Nyxborn hydra, taking part in the most recent telling of a myth repeated through the ages. Jason Rainville brings this legend to life.](img/book/MOT/credits2.webp)![On the Alt-Cover: While the gods look on, the immortal struggle between Haktos and the hydra plays out in the stars of Nyx, a glimpse of eternity captured by Kevin Tong.](img/book/MOT/credits3.webp)