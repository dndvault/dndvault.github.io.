...
![](img/adventure/HotDQ/016-tod-03-01.webp)
...
![Map 3.1: Dragon Hatchery](img/adventure/HotDQ/017-map-3-1-dragon-hatchery.webp)![Player Version](img/adventure/HotDQ/018-map-3-1-dragon-hatchery-player.webp)
### 1. Cave Entrance
...
![Guard Drake](img/adventure/HotDQ/019-tod-03-02.webp)
...
**Frulam Mondath** (see *appendix D*) moved into this simple but comfortable chamber when the camp was abandoned. If no fight has occurred with the guards in area 12 and characters enter this chamber from area 9, then Mondath is here when they arrive. Guards in area 12 hear whatever happens in this chamber and respond dutifully.
